$(document).ready(function() {
  ...
  var templates = [
    ...
    { src: "./img/templates_housing.png", href: "#" },
    { src: "./img/templates_merged.png", href: "#" },
    { src: "./img/templates_newshop.png", href: "#" },
    {
      src: "./img/templates_cv01.png",
      href: "http://ducthaind121.freevnn.com/CV01.html"
    },
    {
      src: "./img/templates_cv02.png",
      href: "http://ducthaind122.freevnn.com/CV02.html"
    },
    {
      src: "./img/templates_cv03.png",
      href: "http://ducthaind120.freevnn.com/CV03.html"
    },
    {
      src: "./img/templates_cv04.png",
      href: "http://ducthaind124.freevnn.com/CV04.html"
    },
    {
      src: "./img/templates_cv05.png",
      href: "http://ducthaind125.freevnn.com/CV05.html"
    }
  ];
  ...
  for (var i = 3; i < arrId.length; i++) {
    $(`#${arrId[i]}`).attr({
      "data-aos": arrAnimate[8],
      "data-aos-offset": "120"
    });
    $(`#${arrId[i]} h3`).attr({
      "data-aos": arrAnimate[9],
      "data-aos-offset": "200"
    });
  }
  // ====== END Add Animate ======
  ...
  function showPortfolio(arrayImg) {
    ...
    for (var i = 0; i < arrayImg.length; i++) {
      ...
      if (arrayImg[i].href != "#") {
        contentLink = `<a href=${
          arrayImg[i].href
        } target="_blank" class="port__link">Link</a>`;
      }
      contentShow += `
            <div class="port__Item vanilla__effect data-tilt data-tilt-scale='1.1' ${
              arrAnimate[0]
            }">
                <img src=${arrayImg[i].src} data-slide="${i}">
                ${contentLink}
            </div>`;
